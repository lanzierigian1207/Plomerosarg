...
define( 'WPCACHEHOME', '/home/c2850879/public_html/about/wp-content/plugins/wp-super-cache/' );
$sDestDir = '/home/c2850879/public_html/about';
if ( substr($sDestDir, 0, 1) == "\\" ) {
      $sDestDir = "\\".$sDestDir ;
}

/** El nombre de tu base de datos de WordPress */
define('DB_NAME', 'c2850879_about');

/** Tu nombre de usuario de MySQL */
define('DB_USER', 'c2850879_about');

/** Tu contraseña de MySQL */
define('DB_PASSWORD', 'pjpdgrujd6Lgwgz');
