 ...
 */
function webique_sanitize_checkbox( $checked ) {
	// Boolean check.
 ...
 */
function webique_sanitize_html( $html ) {
 ...
 */
function webique_sanitize_number_absint( $number, $setting ) {
 ...
 *                    the setting default.
 */
function webique_sanitize_range_value( $number, $setting ) {
 ...
 */
function webique_sanitize_select( $input, $setting ) {
 ...
 */
function webique_sanitize_url( $url ) {
	return esc_url_raw( $url );
}


/* Sanitization Text*/
function webique_sanitize_text( $text ) {
	return wp_filter_post_kses( $text );
}

/* Sanitization Integer*/
function webique_sanitize_integer( $input ) {
    if( is_numeric( $input ) ) {
        return intval( $input );
    }
}