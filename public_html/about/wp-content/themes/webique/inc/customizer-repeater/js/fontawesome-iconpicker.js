(function ($) {
    ...
    wp.webiquecustomizerRepeater = {
        ...
        init: function () {
            $('.iconpicker-items>i').on('click', function () {
                ...
                webique_customizer_repeater_refresh_social_icons(th);
                return false;
            });
        },
    ...
    $(document).ready(function () {
        wp.webiquecustomizerRepeater.init();

        $('.iconpicker-search').on('keyup', function () {
            wp.webiquecustomizerRepeater.search($(this));
        });

        $('.icp-auto').on('click', function () {
            wp.webiquecustomizerRepeater.iconPickerToggle($(this));
        });
